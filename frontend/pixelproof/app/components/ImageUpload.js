    ...
    <div className="max-w-xl mx-auto">
      ...
      >
        ...
        {preview ? (
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
              <button
                ...
                className={`px-4 py-2 rounded-lg flex items-center justify-center transition-all duration-300 ${
                  darkMode
                    ? 'bg-gray-800 hover:bg-gray-700 text-gray-100 shadow-md shadow-gray-900/30 border border-gray-700'
                    : 'bg-gray-100 hover:bg-gray-200 text-gray-800 shadow-md shadow-gray-300/30'
                } hover:scale-105`}
              >
              ...
              <button
                ...
                className={`px-6 py-3 rounded-lg flex-1 sm:flex-none sm:min-w-[160px] flex items-center justify-center transition-all duration-300 transform hover:scale-105 ${
                  darkMode
                    ? 'bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white shadow-lg shadow-blue-900/30 ring-1 ring-blue-400/30'
          ...
          <div className="text-center cursor-pointer relative z-10" onClick={handleButtonClick}>
            <div className={`w-24 h-24 mx-auto rounded-full flex items-center justify-center mb-6 transition-transform transform hover:scale-105 ${
              darkMode ? 'bg-gray-800/90 border border-indigo-700/50 shadow-md shadow-blue-900/20' : 'bg-white/80'
            } shadow-lg`}>
            ...
            <button
              className={`px-6 py-3 rounded-lg inline-flex items-center transition-all duration-300 transform hover:scale-105 ${
                darkMode
                  ? 'bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white shadow-lg shadow-blue-900/30 ring-1 ring-blue-400/30'
                  : 'bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white shadow-lg shadow-blue-500/20'
              } font-medium`}
